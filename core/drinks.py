...
DRINKS: dict[str, Drink] = {
    ...
    "vin_rouge":     Drink("Verre vin rouge",          120, 12.0,  ["vin", "vinrouge", "rouge"]),
    "vin_blanc":     Drink("Verre vin blanc",          120, 11.5,  ["vinblanc", "blanc"]),
    ...
    "bucket":        Drink("Bucket thaïlandais 🪣",     200, 40.0, ["bucket", "buckethai"]),
}
